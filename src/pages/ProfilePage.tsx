...
import { Settings, CreditCard, Clock, Star, ChevronRight, LogOut, ShieldCheck } from 'lucide-react';
...
const menuItems = [
  { icon: Clock, label: 'Historique des trajets' },
  { icon: CreditCard, label: 'Paiements et remboursements' },
  { icon: ShieldCheck, label: "Vérification d'identité" },
      ...
      <div className="mt-6 px-4">
        <div className="bg-card rounded-xl shadow-sm overflow-hidden">
          {menuItems.map((item, index) => (
            <Fragment key={index}>
              <div className="flex items-center justify-between p-4 hover:bg-muted cursor-pointer transition-colors">
