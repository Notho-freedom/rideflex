  ...
  return (
    <div className="min-h-screen bg-background pb-20 lg:pb-8">
      ...
      <RFTabs defaultValue="mode-dispo" className="w-full mt-4">
        ...
        <RFTabsContent value="mode-dispo" className="p-4">
          <div className="max-w-2xl lg:max-w-4xl mx-auto lg:grid lg:grid-cols-2 lg:gap-6 space-y-6 lg:space-y-0">
        ...
        <RFTabsContent value="mes-trajets" className="p-4">
